...
class TextBoxPage(BasePage):
    ...
    def make_a_search(self, tb1,tb2,tb3,tb4):
        ...
        if tex=="Name:asdfrfg \n Email:sdfghj@asdfg.com \n Current Address :sdfghyjkihngbfdres \n Permananet Address :asdcfvghyjuik,":
            elem.setText('aaa')
        #assert_true(tex, "Name:asdfrfg \n Email:sdfghj@asdfg.com \n Current Address :sdfghyjkihngbfdres \n Permananet Address :asdcfvghyjuik,")
        assert "Name:asdfrfg \n Email:sdfghj@asdfg.com \n Current Address :sdfghyjkihngbfdres \n Permananet Address :asdcfvghyjuik" in element.get_attribute('value')
        self.driver.save_screenshot("results/results.png")
driver = webdriver.ChromiumDriver
a=TextBoxPage(driver,wait)
a.make_a_search("asdfrfg","sdfghj@asdfg.com","sdfghyjkihngbfdres","asdcfvghyjuik")